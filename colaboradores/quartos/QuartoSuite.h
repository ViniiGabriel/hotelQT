...
public:
    QuartoSuite(QString tipo, QString titulo, QString descricao, QString valor, QString wifi, QString tv, QString ar, QString sacada,
    ...
    bool codigoQuery(){
        query.prepare("insert into tb_quartos (tipoQuarto, tituloQuarto, descricaoQuarto, valor, wifi, tv, ar, sacada, banheira, roupao, higiene, cafe, servicoQuarto) values"
                      "(:tipoQuarto, :tituloQuarto, :descricaoQuarto, :valor, :wifi, :tv, :ar, :sacada, :banheira, :roupao, :higiene, :cafe, :servicoQuarto)");
